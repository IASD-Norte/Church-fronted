...
// 👉 Componente raíz del popover (sin cambios)
    ...
    <PopoverPrimitive.Content
      ...
      className={cn(
        "bg-popover text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out " +
          ...
          "data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 z-50 w-72 " +
          "origin-[--radix-popover-content-transform-origin] rounded-md border p-4 shadow-md outline-hidden",
        className
      )}
      {...props}
    />
